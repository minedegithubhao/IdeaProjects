...
CREATE TABLE `device_type` (
                               ...
                               `device_type_quantity` int DEFAULT NULL,
...
CREATE TABLE `manufacture` (
                               ...
                               `launch_quantity` int DEFAULT NULL,
...
CREATE TABLE `material_consume` (
                                    ...
                                    `consume_amount` int DEFAULT NULL,
...
CREATE TABLE `sys_permission` (
                                  ...
                                  `parentid` bigint DEFAULT NULL COMMENT '父结点id',
...
CREATE TABLE `technology` (
                              ...
                              `overtime_standard_capacity` int DEFAULT NULL,
                              `overtime_overfulfil_capacity` int DEFAULT NULL,
                              `double_capacity` int DEFAULT NULL,
                              `overfulfil_capacity` int DEFAULT NULL,
...
CREATE TABLE `unqualify_apply` (
                                   ...
                                   `unqualify_count` int DEFAULT NULL,
...
create table s_organ(
                        organ_code varchar(20),
                        organ_name varchar(20),
                        up_organ_code varchar(20)
);

insert into s_organ values ('00', '华夏总行', null), ('0000', '北京分行', '00'),
                           ('0001', '天津分行', '00'), ('0002', '西安分行', '00'),
                           ('0003', '河北分行', '00'), ('000001', '朝内支行', '0000'),
                           ('000002', '潘家园支行', '0000'), ('000003', '姚家园支行', '0000'),
                           ('000200', '西四支行','0002'), ('000201', '小寨支行', '0002'),
                           ('000202', '丈八支行', '0002');